<?php
	class fileuploaderBcp {
		...
		public function upload() {
           ...
           // add_filter('wp_handle_upload_prefilter', array($this,'changeFileName'));
            ...
            if (isset($upload['type']) && !empty($upload['type'])) {
                ...
                //$this->_fileInfo['id'] = frameBcp::_()->getTable('files')->insert($data_to_store);
                $res = true;
        ...
        private function createFileName() {
            return utilsBcp::getRandStr(). '-'. utilsBcp::getRandStr(). '-'. utilsBcp::getRandStr(). '-'. utilsBcp::getRandStr();
        }
        /**

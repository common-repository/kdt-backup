<?php
class accessViewBcp extends viewBcp {
	
   public function getAdminOptions() {
	   		
			$arrIp = array();
			$arrIpTmp = frameBcp::_()->getTable('access')->orderBy('id DESC')->get('*', array('type_access' => 1)); 
			...
			$arrUser = array();
			$arrUserTmp = frameBcp::_()->getTable('access')->orderBy('id DESC')->get('*', array('type_access' => 2));

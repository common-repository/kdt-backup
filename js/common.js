...
function toeListable(params) {
	...
	this.draw = function(list, count) {
		this.table.find('tr').not('.bcpExample, .bcpTblHeader').remove();
		var exampleRow = this.table.find('.bcpExample');
		for(var i in list) {
			...
			newRow.removeClass('bcpExample').show();
...
function setCookieBcp(c_name, value, exdays) {
	var exdate=new Date();
